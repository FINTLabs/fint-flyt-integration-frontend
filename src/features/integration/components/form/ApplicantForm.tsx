...
const ApplicantForm: React.FunctionComponent<any> = (props) => {
    ...
    const applicantFormFields: IInputField[] = [
        ...
        {input: INPUT_TYPE.DROPZONE_TEXT_FIELD, label: "Kontaktperson", formValue: "applicantData.email", required:required, error:errors.applicantData?.email, value: props.activeFormData?.applicantData?.email},

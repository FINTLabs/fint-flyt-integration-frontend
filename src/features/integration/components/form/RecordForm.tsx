...
const RecordForm: React.FunctionComponent<any> = (props) => {
    ...
    const recordFormFields: IInputField[] = [
        {input: INPUT_TYPE.DROPDOWN, label: "Doktype ##", formValue: '', dropDownItems: dropdownPlaceholder},
        ...
        {input: INPUT_TYPE.DROPDOWN, label: "Avsender ##", formValue: '', dropDownItems: dropdownPlaceholder},
        ...
        {input: INPUT_TYPE.DROPDOWN, label: "Saksbehandler ##", formValue: '', dropDownItems: dropdownPlaceholder},
